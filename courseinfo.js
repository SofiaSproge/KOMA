...
import AnimatedPieHooksworked from './doughnut_course_worked_time.js';
...
function hour_donut_text(myData) {
    ...
    <div className="App">
        ...
        <div id="wrapper">
         ...
         <div className="botton">
            <button onClick={() =>( myData[0].id, myData[0].startDate,myData[0].endDate,myData[0].value)} className="reportButton">
               <p className="buttonText" id="reportButtonText">Report time</p>
            </button>
          
            <button onClick={() =>( myData[0].id, myData[0].startDate,myData[0].endDate,myData[0].value)} className="editButton">
